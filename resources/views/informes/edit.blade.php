...
@section('title','Informes legislativos - Actualizar')
@section('content')
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="ejercicio_id" name="ejercicio_id" required>
                ...
                @foreach($ejercicios as $ejercicio)
                    <option value="{{ $ejercicio->id }}" {{ $informe->ejercicio_id == $ejercicio->id ? 'selected' : '' }}>
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="card-body">
                ...
                <table class="table table-light table-hover table-small" id="itemsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form id="delete-form-{{ $item->id }}" action="{{ route('informes.item.destroy', $item->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="alert alert-info">
                    No hay items asociados a este informe. Puedes agregar nuevos items utilizando el formulario de carga de archivos.
                </div>
                @endif
            </div>
        </div>
        <div class="col-sm-12 col-lg-6">
            <div class="card p-3">
                <form class="frmItems" enctype="multipart/form-data">
                    ...
                    <button type="button" class="btn btn-primary" id="agregarItemInforme">Agregar Item</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    $("#agregarItemInforme").click(function(event) {
        ...
        data.append('informe_id', $("#informe_id").val());

        guardarArchivo(data, "{{route('informes.item.create')}}");
